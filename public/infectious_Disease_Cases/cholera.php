...
<body>
	...
	<div class="container">
		<h2 class="text-logo">
		  CHOLERA Monitoring Barangay Cases Dashboard 
	    </h2>
		<table class="table-1">
			<thead>
			...
			<tbody>
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bagbaguin'";
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bagbaguin' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bagbaguin' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bagbaguin' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<tr>
						...
						<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bahay_Pare'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
						...
						<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bahay_Pare' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_bagbaguin_active_cases = $values['total'];
						...
						<td data-label="Recovered Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bahay_Pare' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_bagbaguin_recovered_cases = $values['total'];
						...
						<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bahay_Pare' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_bagbaguin_death_cases = $values['total'];
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Banga'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Banga' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Banga' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Banga' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bancal' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bancal' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bayugo'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bayugo' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bayugo' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Bayugo' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Caingin'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Caingin' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_bayugo_active_cases = $values['total'];
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'caingin' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'caingin' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Calvario'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Calvario' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Calvario' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Calvario' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Camalig'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Camalig' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Camalig' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Camalig' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Hulo'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Hulo' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Hulo' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Hulo' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'iba'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'iba' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'iba' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'iba' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'langka'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_iba_confirmed_cases = $values['total'];
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'langka' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_iba_active_cases = $values['total'];
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'langka' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_iba_recovered_cases = $values['total'];
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'langka' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
 							$total_iba_death_cases = $values['total'];
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'lawa'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'lawa' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'lawa' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'lawa' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'libtong'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'libtong' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'libtong' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'libtong' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'liputan'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'liputan' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'liputan' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'liputan' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'longos'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'Longos' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'longos' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'longos' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'malhacan'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'malhacan' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'malhacan' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'malhacan' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pajo'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pajo' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pajo' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pajo' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pandayan'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pandayan' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pandayan' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pandayan' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pantoc'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pantoc' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pantoc' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'pantoc' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'perez'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'perez' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'perez' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'perez' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'poblacion'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'poblacion' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'poblacion' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'poblacion' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'gasak'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'gasak' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'saluysoy' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'saluysoy' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'saluysoy'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'saluysoy' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'tugatog'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'tugatog' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'tugatog' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'tugatog' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'ubihan'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'ubihan' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'ubihan' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'ubihan' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
				...
				<tr>
					...
					<td data-label="Confirmed Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'zamora'";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Active Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'zamora' AND status = 'Active' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Recovered Cases">
						<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'zamora' AND status = 'Recovered' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
					...
					<td data-label="Death Cases">
							<?php
 							...
 							$sql = "SELECT COUNT(*) AS total FROM cholera WHERE barangay = 'zamora' AND status = 'Death' ";
 							$result = mysqli_query($con,$sql);
 							$values = mysqli_fetch_assoc($result);
