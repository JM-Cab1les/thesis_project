...
<body class="bg-light">
        ...
        <div class=" dropdown dropdown-container">
            <button class="btn btn-secondary " type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu menu-item" aria-labelledby="dropdownMenu">
                    <li><a class="dropdown-item"><i class="fa-solid fa-user"></i> 
                    <?php
				    if(!isset($_SESSION)){
					session_start();
				    }
                    ...
                    <li>
                        <a class="dropdown-item" href="../logout(1).php"><i class="fa-solid fa-right-from-bracket"></i>Logout</a>
                    </li>
                </ul>
            </ul>
          </div>
    ...
    <h2 class="text-center mt-5">Infectious Disease Patient Registration Select</h2>
    <div class="row fluid-container" id="card-container">
       
        <div class="col-lg-4 col-md-6 mb-3">
            <a href="covid-19/covid-19-registration.php">
                <div class="card">
                    <div class="card-body">
