...
if(isset($_POST['update']))
{
   ...
   $sql = "UPDATE lockdown SET lockdown_status = '$lockdown_stats' WHERE Barangay = 'Bayugo'";

   $con->query($sql) or die ($con->error);

  
   $remarks = $_POST['sitio'];
   $sqls = "UPDATE street SET Sitio = '$remarks' WHERE Barangay ='Bayugo'";
...
<html lang="en">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="bayugo.php" class="active">Summary Report Per Barangay</a>
                                    </li>
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 1 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 2 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 3 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 4 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 5 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 6 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 7 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 8 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 9 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 10 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 11 AND barangay = 'Bayugo'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 12 AND barangay = 'Bayugo'";
