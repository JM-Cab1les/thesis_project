...
if(isset($_POST['update']))
{
   ...
   $sql = "UPDATE lockdown SET lockdown_status = '$lockdown_stats' WHERE Barangay = 'Gasak'";

   $con->query($sql) or die ($con->error);

  
   $remarks = $_POST['sitio'];
   $sqls = "UPDATE street SET Sitio = '$remarks' WHERE Barangay ='Gasak'";
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="st-francis.php" class="active">Summary Report Per Barangay</a>
                                    </li>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading text-center panel-header">
                                    St Francis Gasak Summary Report
                                </div>
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 1 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 2 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 3 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 4 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 5 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 6 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 7 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 8 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 9 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 10 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 11 AND barangay = 'Gasak'";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE month(date_issued) = 12 AND barangay = 'Gasak'";
