...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 3";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 1";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 2";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 4";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 5";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 6";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 7";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 8";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 9";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 10";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 11";
...
$sql = "SELECT COUNT(*) AS total from covid_19_2020 WHERE month(date_issued) = 12";
...
<html lang="en">
    <head>
        ...
        <title>COVID-19 DashBoard - Yearly Statistical Report</title>
        ...
        <link href="css/yearly_report.css?v=<?php echo time();?>" rel="stylesheet">
        <!-- Custom Fonts -->
    ...
    <body>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="yearly_report.php" class="active">Past Year Reports</a>
                                    </li>
                                    <li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading text-center">
                                    2021 Statistical Report (COVID-19)
                                </div>
                                <div class="panel-body panel-container">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading text-center">
                                    2020 Statistical Report (COVID-19)
                                </div>
                                <div class="panel-body panel-container">
        ...
        <script src="js/yearly_report.js"></script>
...
const cts = document.getElementById('myCharts').getContext('2d');
       const myCharts = new Chart(cts, {
       type: 'bar',
        data: {
            labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November','December'],
            datasets: [{
    ...
    const ctv = document.getElementById('myChartss').getContext('2d');
       const myChartss = new Chart(ctv, {
       type: 'bar',
        data: {
            labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November','December'],
            datasets: [{
            label: 'No. of Cases',
            data: [<?php echo $total_jan; ?>, <?php echo $total_feb; ?>,<?php echo $total_march; ?>, 59,41,35,28,10,28,23,22,10],
            backgroundColor: [
                '#42a5f5',
                '#42a5f5',
                '#42a5f5',
