...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 1";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 2 ";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 3";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 4";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 5";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 6";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 7";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 8";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 9";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 10";
  $result_jan = mysqli_query($con,$sql);
...
<html lang="en">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="week1-10.php" class="active"><i class="fa fa-calendar fa-fw"></i> Week 1-10</a>
                                    </li>
                    ...
                    <div class="row">
                            <div class="panel panel-default">
                                <div class="panel-heading text-center">
                                    2022 Week 1-10 Statistical Report (COVID-19)
                                </div>
    ...
    <script>
       ...
       type: 'bar',
     data: {
        labels: ['Jan 2 - Jan 8 (Week1)', 'jan 9 - Jan 15 (Week2)', 'Jan 16 - Jan 22 (Week3)', 'Jan 23 - Jan 29 (Week4)','Jan 30 - Feb 5 (Week5)','Feb 6 - Feb 12 (Week6)','Feb 13 - Feb 19 (Week7)','Feb 20 - Feb 26 (Week8)','Feb 27 - Mar 5 (Week9)','Mar 6 - Mar 12 (Week10)'],
        datasets: [{
            label: 'No. of Cases',
