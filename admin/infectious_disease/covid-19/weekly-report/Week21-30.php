...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 21";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 22";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 23";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 24";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 25";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 26";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 27";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 28";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 29";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 30";
  $result_jan = mysqli_query($con,$sql);
...
<html lang="en">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="week21-30.php" class="active"><i class="fa fa-calendar fa-fw"></i> Week 21-30</a>
                                    </li>
                    ...
                    <div class="row">
                            <div class="panel panel-default">
                                <div class="panel-heading text-center">
                                    2022 Week 21-30 Statistical Report (COVID-19)
                                </div>
    ...
    <script>
       ...
       type: 'bar',
     data: {
        labels: ['May 22 - May 28 (Week21)', 'May 29 - Jun 4 (Week22)', 'Jun 5 - June 11 (Week23)', 'June 12 - June 18 (Week24)','June 19 - June 25 (Week25)','June 26 - Jul 2 (Week26)','Jul 3 - Jul 9 (Week27)','Jul 10 - Jul 16 (Week28)','Jul 17 - Jul 23 (Week29)','Jul 24 -  Jul 30 (Week30)'],
        datasets: [{
            label: 'No. of Cases',
