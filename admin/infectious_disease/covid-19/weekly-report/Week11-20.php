...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 11";
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 12";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 13";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 14";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 15";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 16";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 17";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 18";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 19";
  $result_jan = mysqli_query($con,$sql);
...
<?php
  ...
  $sql = "SELECT COUNT(*) AS total from covid_19 WHERE week(date_issued) = 20";
  $result_jan = mysqli_query($con,$sql);
...
<html lang="en">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="week11-20.php" class="active"><i class="fa fa-calendar fa-fw"></i> Week 11-20</a>
                                    </li>
                    ...
                    <div class="row">
                            <div class="panel panel-default">
                                <div class="panel-heading text-center">
                                    2022 Week 11-20 Statistical Report (COVID-19)
                                </div>
    ...
    <script>
       ...
       type: 'bar',
     data: {
        labels: ['Mar 13 - Mar 19 (Week11)', 'Mar 20 - Mar 26 (Week12)', 'Mar 27 - Apr 2 (Week13)', 'Apr 3 - Apr 9 (Week14)','Apr 10 - Apr 16 (Week15)','Apr 17 - Apr 23 (Week16)','Apr 24 - Apr 30 (Week17)','May 1 - May 7 (Week18)','May 8 - May 14 (Week19)','May 15 - May 21 (Week20)'],
        datasets: [{
            label: 'No. of Cases',
