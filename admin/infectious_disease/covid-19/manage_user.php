...
<html lang="en">
    <head>
        ...
        <link href="css/manage_user.css?v=<?php echo time();?>" rel="stylesheet">
        <!-- Custom Fonts -->
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="manage_user.php" class="active"><i class="fa fa-user fa-fw"></i>Manage User</a>
                            </li>
                            <li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="btn-grp">
                                    <a class="btn btn-primary" href="add-new-user/add-new-user.php"><i class="fa fa-user-plus"></i> Add User</a>
                                </div>
                                            ...
                                            <thead>
                                                ...
                                                <?php do{ ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                         <?php echo $row['barangay_accessed'];?>
                                                        </td>
                                                        <td>
                                                            <a href="edit-user/edit-user.php?id= <?php echo $row['id'];?>"><i class="fa fa-edit fa-fw user-action"></i></a>
                                                            <a href="delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Click OK to confirm')" ><i class="fa fa-trash-o fa-fw user-action"></i></a>
                                                        </td>
                                                    </tr>
